...
const empreendimentos = [
    ...
    { id: 36, nome: 'Mood Design Regente Feijó · Holos', regiao: 'leste', local: 'Regente Feijó · Av. Sapopemba', dormitorios: [1, 2], status: 'lancamento', desc: '1 e 2 dorms. com varanda | 25,60m² a 65m² | MCMV · 2 torres | próx. estação Santa Clara (Linha 2 Verde)', amenities: ['Piscinas', 'Academia', 'Pet Place', 'Minimercado'], imagem: 'assets/empreendimentos/36.png' },
    { id: 37, nome: 'Mood Vila Matilde · Holos', regiao: 'leste', local: 'Vila Matilde · Rua Dr. Heládio', dormitorios: [1, 2], status: 'lancamento', desc: '1 e 2 dorms. com varanda | 28,98m² a 74,68m² | MCMV · sucesso de vendas | a 5 min da estação Vila Matilde (Linha 3)', amenities: ['Piscinas', 'Academia', 'Pet Place', 'Coworking'], imagem: 'assets/empreendimentos/37.png' },
    { id: 38, nome: 'Zoom Parque Ecológico · Holos', regiao: 'leste', local: 'Vila Silvia · Lauro de Freitas x São José Ribamar', dormitorios: 2, status: 'lancamento', desc: '2 dorms. com varanda | 35,51m² a 86,83m² | MCMV · breve lançamento | a 1 min da Av. Dr. Assis Ribeiro | próx. Parque Ecológico do Tietê', amenities: ['Piscinas', 'Academia', 'Pet Place', 'Mercadinho'], imagem: 'assets/empreendimentos/38.png' },
    { id: 39, nome: 'DOMO Jardim Penha', regiao: 'leste', local: 'Jardim Penha · Rua Monsenhor Meirelles, 249', dormitorios: 2, status: 'lancamento', desc: '2 dorms. · 30m² a 42,80m² | Domo Empreendimentos · rooftop, piscina e lazer completo', amenities: ['Piscina', 'Rooftop', 'Pet Place', 'Salão de Festas'], imagem: 'assets/empreendimentos/39.png' },
    { id: 40, nome: 'Serena Residence · Emccamp', regiao: 'leste', local: 'Vila Sílvia · R. Nova Itarana, 11', dormitorios: 2, status: 'obras', desc: '2 dorms. · 40–41m² | Emccamp · varanda com ponto grill, opção de vaga | MCMV · próx. Parque Ecológico do Tietê e metrô', amenities: ['Piscina', 'Academia', 'Pet Place', 'Salão de Festas'], imagem: 'assets/empreendimentos/40.png' },
